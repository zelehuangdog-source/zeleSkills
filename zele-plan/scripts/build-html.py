...
# -*- coding: utf-8 -*-
"""
zele-plan 渲染脚本：把技术方案 markdown 渲染为单文件自包含的 HTML。
...
用法：
    python3 build-html.py 技术方案.md              # 输出同目录同名 .html
    python3 build-html.py 技术方案.md -o out.html
    python3 build-html.py 技术方案.md --open
    python3 build-html.py 技术方案.md --no-render  # 跳过 puml 渲染，直接用已有 svg
...
def main():
    parser = argparse.ArgumentParser(
        description="把 zele-plan 技术方案 markdown 渲染为单文件自包含 HTML"
    )
    parser.add_argument("markdown", help="技术方案 markdown 文件路径")
